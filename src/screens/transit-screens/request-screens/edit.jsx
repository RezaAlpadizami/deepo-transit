    ...
    <div>
      <div className="bg-white p-5 rounded-[55px] py-12 drop-shadow-md">
        <div className="grid-cols-2 gap-4 flex max-[640px]:flex-col">
          <fieldset className="border border-borders shadow-custom w-full h-full px-8 py-12 rounded-[55px] mx-4 max-[640px]:px-2 max-[640px]:mx-0">
              ...
              return (
                <div className="flex" key={product_id}>
                  <div className="my-4 mr-4 max-[640px]:mr-0">
                    ...
                    >
                      <img src={deleteIcon} alt="delete Icon" className="max-[640px]:w-12 max-[640px]:h-12" />
                    </Button>
                  </div>
                  <InputDetail
