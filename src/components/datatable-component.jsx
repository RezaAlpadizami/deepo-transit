...
function DataTable(props) {
  ...
  return (
    <Fade in={filters.length > 0}>
                      ...
                      return (
                        <div className={item.col ? `col-span-${item.col}` : ''} key={`component${idx}`}>
                          <Input
                            ...
                            register={register}
                            control={control}
                            icon={<img src={item.icon} alt={`${item.alt}`} className="h-4 mb-1" />}
                          />
                        </div>
                      );
                    }
      ...
      <div className={`${!isInOut ? 'border border-[#C2C2C2]' : ''} rounded-md`}>
        {renderToolbar() && (
          <Toolbar
        ...
        {filter.length !== 0 && (
          <div className="overflow-x-auto relative px-6 pb-11 rounded-b-3xl">
